...
--
-- Table structure for table `speakers_schedule`
--
...
--
-- Dumping data for table `speakers_schedule`
--

INSERT INTO `speakers_schedule` (`id`, `speaker_id`, `username`, `topic`, `venue`, `date`, `time`) VALUES
