...
<html>
    ...
    <body class="text-center">
        {{-- @foreach ($info as $info) --}}
            ...
            {{-- <hr style="clear:both;"/> --}}
            <h1 style="font-size: 35px;">{{ $info->last_name }}, {{ $info->first_name }}, MD</h1>
            <div style="">
                {{-- <h1 style="padding-left: 237px;">{!! DNS1D::getBarcodeHTML("$info->psa_id", 'C128',4,60, 'black', true) !!}</h1> --}}
                <img style="width: 18%" src="images/QR_CODES/{{ str_pad($info->psa_id, 4, '0', STR_PAD_LEFT) }}.png" alt="ASEAN CONGRESS OF ANESTHESIOLOGISTS">
            </div>
