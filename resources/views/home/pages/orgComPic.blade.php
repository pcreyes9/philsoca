...
@section('content')
    {{-- @include('home.banner') --}}
    <section id="main-container" class="main-container pb-4 px-3">
        <div class="container">
            <div class="row text-center">
                <div class="col-lg-12">
                  <h3 class="section-sub-title">The 24th ASEAN Congress of Anesthesiologists (ACA 2024) Organizing Committee</h3>
                </div>
            </div>
              <!--/ Title row end -->
            <div class="row text-center">
              <div class="col-lg-12">
                  <h3 class="orgcom-title text-center mb-4">Overall CHAIR</h3>
              </div>
            </div>
